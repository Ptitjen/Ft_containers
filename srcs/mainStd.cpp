...
template <class T, class U> void printMap(std::map<T, U> m) {
  if (m.size() == 0) {
    std::cout << "Empty" << std::endl;
    return;
  }
  ...
  try {
    {
      ...
      /* *************** ITERATORS **************** */
      {
        ...
        std::vector<int>::iterator it = my_v.end();
        it--;
    ...
    }
    {
      ...
      /**** PERFORMANCE ****/
      {
        ...
        ChronoMono chrono;
        chrono.begin();
        std::map<int, char> my_m1;
        for (int i = 0; i < 1000000; i++) {
          my_m1.insert(std::pair<int, char>(i, '$'));
        }
        my_m1.erase(1);
        my_m1.erase(50000);
        my_m1.erase(100000);
        ...
        for (int i = 0; i < 1000000; i++) {
          int n = rand() % 10000000;
          my_m1.insert(std::pair<int, char>(n, '$'));
        }
        std::map<int, char> my_m2(my_m1);
        chrono.stop();
      }
      ChronoMono chrono;
      chrono.begin();
      {
        ...
        /* ***************************************************************** */
        {
          std::cout << BOLDBLUE "********* Constructors *********" END
                    << std::endl;
          std::map<int, char> my_m;
          std::map<int, char> my_m_it;
          for (int i = 0; i < 10; i++) {
            my_m_it.insert(std::pair<int, char>(i, '@'));
          }
          std::map<int, char> my_m_it_cpy(my_m_it.begin(), my_m_it.end());
          std::map<int, char> my_m1;
          my_m1 = my_m;
          std::map<int, char> my_m2(my_m1);
          printMap(my_m);
        ...
        /* ***************************************************************** */
        {
          ...
          std::map<int, char> my_m;
          for (int i = 33; i < 65; i++) {
            my_m.insert(std::pair<int, char>(i, (char)i));
          }
          printMap(my_m);
          std::cout << std::endl
                    << BOLDCYAN "Iterator increment" END << std::endl;

          for (std::map<int, char>::iterator it = my_m.begin();
               it != my_m.end(); it++) {
            std::cout << it->first << " " << it->second << " | ";
          }
          ...
          for (std::map<int, char>::iterator it = my_m.end();
               it != my_m.begin(); it--) {
            std::map<int, char>::iterator itc = it;
            itc--;
          ...
          for (std::map<int, char>::reverse_iterator it = my_m.rbegin();
               it != my_m.rend(); it++) {
            std::cout << it->first << " " << it->second << " | ";
          }
          ...
          for (std::map<int, char>::reverse_iterator it = my_m.rend();
               it != my_m.rbegin(); it--) {
            std::map<int, char>::reverse_iterator itc = it;
            itc--;
            std::cout << itc->first << " " << itc->second << " | ";
          }
        }
         ...
         */
        {
          ...
          std::cout << std::endl << BOLDCYAN "Basic insert : " END << std::endl;
          {
            ...
            my_m.insert(std::pair<int, char>(34, '@'));
            printMap(my_m);
          }
          ...
          std::cout << std::endl << BOLDCYAN "Hint insert : " END << std::endl;
          {
            ...
            for (int i = 33; i < 55; i++) {
              my_m.insert(my_m.find(i - 1), std::pair<int, char>(i, (char)i));
            }
            printMap(my_m);
          }
          std::cout << std::endl
                    << BOLDCYAN "Iterator insert : " END << std::endl;
          {
            ...
            for (int i = 32; i < 54; i++) {
              i++;
              my_m1.insert(std::pair<int, char>(i, (char)i));
            }
         ...
         */
        {
          ...
          std::cout << ((my_m != my_m1) ? "Y" : "N");
          std::cout << ((my_m > my_m1) ? "Y" : "N");
          my_m1.insert(std::pair<int, char>(98, '@'));
          std::cout << ((my_m == my_m1) ? "Y" : "N");
          std::cout << ((my_m < my_m1) ? "Y" : "N");
          std::cout << ((my_m <= my_m1) ? "Y" : "N");
          std::cout << ((my_m >= my_m1) ? "Y" : "N");
    ...
    }
    {
      ...
      /* *************** PERFORMANCE TESTS **************** */ // OK
      {
        ...
        ChronoMono chrono;
        chrono.begin();
        std::stack<int> my_large_s = std::stack<int>();
    ...
    }
    {
      ...
      std::pair<int, char> pair2 = std::make_pair(2, 'b');
