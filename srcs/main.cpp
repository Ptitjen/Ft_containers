...
int main(void) {
  ...
  //     std::cout << "Insert one value 42 at begin: " << std::endl;
  //     std::cout << "Return value : " RED << *(v.insert(v.begin(), 42)) <<
  //     END
  //               << std::endl;
  //     print_int_ftvector(v);
  ...
  //     std::cout << BOLDCYAN "Erase" END << std::endl;
  //     std::cout << CYAN "Erase position 2 : " END << std::endl;
  //     std::cout << "Return value : " RED << *(v.erase(v.begin() + 2)) <<
  //     END
  //               << std::endl;
  //     print_int_ftvector(v);
  ...
  //     std::cout << CYAN "Erase from 2 to 5 (excluding 5): " END <<
  //     std::endl; std::cout << "Return value : " RED
  //               << *(v.erase(v.begin() + 2, v.begin() + 5)) << END <<
  //               std::endl;
  //     print_int_ftvector(v);

  //     std::cout << CYAN "Erase from 5 to 9 (excluding 9): " END <<
  //     std::endl; std::cout << "Return value : " RED
  //               << *(v.erase(v.begin() + 5, v.begin() + 9)) << END <<
  //               std::endl;
  //     print_int_ftvector(v);
  ...
  //     std::cout << "on not empty vector with other vector 5 4 3 2 1 (2
  //     values): "
  //               << std::endl;
  //     v.assign(to_assign.begin(), to_assign.begin() + 2);
  //     print_int_ftvector(v);
  ...
  //     std::cout << "Printing vector with reverse iterator : " << std::endl;
  //     std::cout << "End adress : " << &*(myvector.end()) << std::endl;
  //     std::cout << "Rbegin adress : " << &*(myvector.rbegin()) <<
  //     std::endl; for (ft::vector<int>::reverse_iterator it =
  //     myvector.rend();
  //          it != myvector.rbegin(); --it) {
  //       std::cout << *(it - 1) << std::endl;
  //     }
  ...
  //   {
  //     std::cout << BOLDCYAN "Vector of 4 int without value : " END <<
  //     std::endl; ft::vector<int> v = ft::vector<int>(4);
  //     print_int_ftvector(v);
  //     v[0] = 1;
  //     print_int_ftvector(v);
  //   }
  ...
  //   /***** Constructor vector(nb elem, value) *****/
  //   {
  //     std::cout << BOLDCYAN "Vector of 10 unsigned int with value 42 : "
  //     END
  //               << std::endl;
  //     unsigned int i = 42;
  //     ft::vector<unsigned int> v = ft::vector<unsigned int>(10, i);
  ...
  //   /*****Iterator constructor *****/
  //   {
  //     std::cout << BOLDCYAN "Constructor using iterators :" END <<
  //     std::endl;
